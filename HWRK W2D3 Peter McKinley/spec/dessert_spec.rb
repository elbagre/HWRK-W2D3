...
describe Dessert do
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array"
      brownie.add_ingredient("pasta")
      expect(brownie.ingredients).to include("pasta")
  end

  describe "#mix!" do
    it "shuffles the ingredient array"
      ingredients = ["pasta", "bacon", "potatoes", "rhubarb", "sour cream"]
  ...
  describe "#eat" do
    it "subtracts an amount from the quantity"
      brownie.eat(5)
      expect(brownie.quantity).to_eq(95)
